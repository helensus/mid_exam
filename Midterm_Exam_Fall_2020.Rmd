...
# ggplot(data = phone, aes(x=Charge,y = Use))+ geom_point()+
# geom_smooth(formula = "y~x", method = "lm")


model2<-stan_glm(Use~Charge+Group, data=phone,refresh=0)
print(model2)
...
The slope of 7.34 means that if a person does not charge the phone in one day than on average he would spend 7.34 hours on phone daily.
If the person is a student, they are expected to spend 0.95 hours less on phones every day corparing to an employed person. The slope coefficient 0.33 means that with one more charging attempt in a day, on average the person would spend 0.33 hours more on phone daily.
...
*I would like to have some suggestions about how to deal with "n", "na" in the surveys. I did not deleted them all as I don't have so many samples if they are deleted. 
