...
参数理解
*Looking at the coefficients, if the person is a student, they are expected to spend . The slope coefficient of 0.2 means that professors with 1 more point in beauty score seem to have evaluations 0.2 points higher.
